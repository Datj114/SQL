...
CREATE TABLE NHANVIEN(
	...
	SELECT DISTINCT NHANVIEN.MANV, TENVN, TRINHDO FROM NHANVIEN
	JOIN THAMGIA ON NHANVIEN.MANV=THAMGIA.MANV
	WHERE NGAYSINH =(SELECT MIN(NGAYSINH) FROM NHANVIEN JOIN THAMGIA ON NHANVIEN.MANV=THAMGIA.MANV WHERE MAKH='KH03') 
